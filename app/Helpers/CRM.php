...
class CRM
{
    ...
    public static $scopes = 'businesses.readonly calendars.readonly calendars.write calendars/resources.write calendars/resources.readonly businesses.write conversations.readonly conversations.write conversations/message.readonly conversations/message.write conversations/reports.readonly conversations/livechat.write contacts.readonly contacts.write forms.write forms.readonly locations.readonly locations/customValues.readonly locations/customValues.write locations/customFields.readonly locations/customFields.write locations/tasks.readonly locations/tasks.write locations/tags.readonly locations/tags.write opportunities.readonly opportunities.write users.readonly';
    ...
    public static function crm_token($code = '', $method = '')
    {
        ...
        // $data['crm_Master_key'] = static::getDefault('crm_Master_key');
        $data[$md] = $code;
